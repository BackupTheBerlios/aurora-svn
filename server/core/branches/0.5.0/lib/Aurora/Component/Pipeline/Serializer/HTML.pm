package Aurora::Component::Pipeline::Serializer::HTML;
use strict;
...
sub run {
  ...
  unless($content->content_type eq 'text/html') {
...
Aurora::Component::Pipeline::Serializer::HTML - This component
serializes the current content to HTML.
